        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <div class="relative" x-data="{ open: false }" @click.away="open = false">
                    ...
                    <div x-show="open" style="display: none;" @click="open = false" class="absolute z-50 mt-2 w-48 rounded-md shadow-lg origin-top-right right-0">
            ...
            <!-- ... (Hamburger menu untuk mobile, jika ada) ... -->
        </div>
    </div>
</nav>
